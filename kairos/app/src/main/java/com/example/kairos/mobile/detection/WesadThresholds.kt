 ...
 *
 * Todos los valores de esta clase tienen justificación empírica documentada en el
 * Notebook 01 (exploración WESAD) y en el análisis de umbrales de la tesis.
 *
...
object WesadThresholds {
    ...
    /**
     * Media global de HR en estado basal (Baseline) sobre 15 sujetos WESAD.
     * Se usa como fallback de [RunningStats] antes de completar la calibración personal.
     * Unidad: BPM.
     */
     ...
     * Se usa como fallback de [RunningStats] para el cálculo de Z-scores iniciales.
     * Unidad: BPM.
     */
     ...
     *
     * Valor derivado del análisis del acelerómetro en WESAD:
     * las magnitudes de baseline (~63.4) y estrés (~62.9) son similares,
     * confirmando que el TSST no involucra movimiento físico significativo.
     ...
     *
     * Ventanas de 60 segundos son el estándar en la literatura de HRV:
     * proveen suficientes intervalos RR para calcular RMSSD confiable
     * y coinciden con la configuración del modelo entrenado en WESAD.
     * Unidad: segundos.
     */
    const val ANALYSIS_WINDOW_SECONDS = 60L

    /**
     * Número mínimo de ventanas de baseline requeridas para completar la calibración.
     *
     * Con 3 ventanas de 60 segundos (3 minutos en total), el algoritmo de Welford
     * tiene suficientes muestras para estimar la media y desviación estándar personal
     ...
     * (susto, esfuerzo puntual, artefacto de sensor).
